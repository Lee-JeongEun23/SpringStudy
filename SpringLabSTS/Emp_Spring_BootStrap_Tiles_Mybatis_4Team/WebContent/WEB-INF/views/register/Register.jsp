                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="form-label-group">
                                                        	 <input type="text" id="deptno" name="deptno" class="form-control" placeholder="deptno" required="required">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-label-group">
                                                        	<input type="text" id="mgr" name="mgr" class="form-control" placeholder="mgr" required="required">
